...
public class Registrar extends javax.swing.JFrame {
    ...
    public Registrar() {
        ...
        ImageIcon icono = new javax.swing.ImageIcon(getClass().getResource("/imagenes/agregar.png"));
    ...
    private void initComponents() {
        ...
        jTextField5.setToolTipText("ejemplo #123 colonia C.P.");
        ...
        jLabel6.setText("Registra un nuevo usuario");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.apellido = jTextField2.getText();
        this.telefono = jTextField3.getText();
        this.correo = jTextField4.getText();
        this.direccion = jTextField5.getText();
        
        metodosAgenda ma = new metodosAgenda();
        
        ma.insertar(nombre, apellido, telefono, correo, direccion);
        
        JOptionPane.showMessageDialog(null,nombre + " registrado con exito");
